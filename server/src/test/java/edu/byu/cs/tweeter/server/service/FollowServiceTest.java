...
public class FollowServiceTest {
    ...
    private FollowDynamoDB mockFollowDynamoDB;
    ...
    public void setup() {
        ...
        mockFollowDynamoDB = Mockito.mock(FollowDynamoDB.class);
        Mockito.when(mockFollowDynamoDB.getFollowing(request)).thenReturn(expectedResponse);

        followServiceSpy = Mockito.spy(FollowService.class);
        Mockito.when(followServiceSpy.getFollowingDAO()).thenReturn(mockFollowDynamoDB);
    }

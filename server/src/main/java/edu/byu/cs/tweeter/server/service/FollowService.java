...
public class FollowService {
     ...
     * followees after any that were returned in a previous request. Uses the {@link FollowDynamoDB} to
     * get the followees.
     *
...
//            response = new UnfollowResponse("Authtoken expired");
    ...
    /**
     * Returns an instance of {@link FollowDynamoDB}. Allows mocking of the FollowDAO class
